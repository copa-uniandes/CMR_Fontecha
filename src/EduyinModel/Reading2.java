 ...
 * @author 	/John Edgar Fontecha García para Modelo Eduyin
...
public class Reading2 {
	...
	public Reading2(String route){
		try{
			...
			int head=0; 
			double tt=0.0;
			in2=new BufferedReader(new FileReader("./data/Eduyin_b.dat"));
			String line2;
			int i=0;
...
//						System.out.println("Entro a N");
					...
					h=new MNode(i,nccm,ncpm, ncwt,ntcm,ntpm, nperc,0,0,nd, nopt, nwaiting,0,0);
					g.addNode(h);
					i++;
				}
