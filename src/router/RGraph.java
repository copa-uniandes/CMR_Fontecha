...
public class RGraph {
	 ...
	 * @param na arcs array
	 */
	public RGraph(ArrayList<RNode> nd, ArrayList<RArc> na){
		this.setNodes(nd);
		this.setArcs(na);
	}
	/**
	 ...
	 * @return arcs
	 */
	public void setArcs(ArrayList<RArc> arcs) {
		this.arcs = arcs;
	}
	/**
