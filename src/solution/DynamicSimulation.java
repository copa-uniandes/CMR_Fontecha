...
public class DynamicSimulation {
	...
	public DynamicSimulation(RGraph gvrp, MGraph gmm, ArrayList<RGraph> smallgraphs, ArrayList<ArrayList<ArrayList<Tres>>> rutas_todas2, ArrayList<ArrayList<ArrayList<Double>>> horas_todas2, double VEL, int iteraciones) throws FileNotFoundException, UnsupportedEncodingException{
		...
		for (int i = 0; i < iteraciones; i++) {
			...
			int num_rutas_iter = 0;
			double oper_per_route = 0;
...
//			System.out.println("Tamano gmm :"+gmm.getNodes().size());
			...
			for (int k = 0; k < gmm.getNodes().size(); k++) {
				RNG=rndGenerator.nextDouble();
				double nexttime = smallgraphs.get(0).getTmin() + gmm.getNodebyID(k+1).getD().inverseF(RNG);
						...
						if(rutas_todas.get(j).get(k).get(k2).getEventsSitesID() != 0){
							...
							if (NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] < horas_todas.get(j).get(k).get(k2) ) { //Si el sitio falló antes de ser reparado
								...
								if(LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] != 0){ // Si ya lo he visitado
									...
									denom_costo_ciclo++;
									main_cost[i] = main_cost[i] + ((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCw() * (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCcm())/(horas_todas.get(j).get(k).get(k2) +gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTcm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]));
									if(((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCw() * (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCcm())/(horas_todas.get(j).get(k).get(k2) +gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTcm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]))<0) {
										System.out.println("Paila"+" "+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCw() * (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCcm()+" "+(horas_todas.get(j).get(k).get(k2) +gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTcm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]));
									}
									//System.out.println(horas_todas.get(j).get(k).get(k2) - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]);
								}else{
									costo_ciclo_prom = costo_ciclo_prom + (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]);
									...
									if(((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCw() * (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCcm())/(gvrp.getNodes().get(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1).getCycletime()))<0) {
										System.out.println("Paila"+" "+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCw() * (horas_todas.get(j).get(k).get(k2) - NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCcm()+" "+(gvrp.getNodes().get(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1).getCycletime()));
									}
								...
								cuantas_fallaron++;
								RNG=rndGenerator.nextDouble();
								NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] = horas_todas.get(j).get(k).get(k2) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTcm() + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getD().inverseF(RNG); // Actualizo el tiempo de falla
								LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] = horas_todas.get(j).get(k).get(k2)+ gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTcm();
								...
								if(LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] != 0){ // Si el sitio ya se visitó
									main_cost[i] = main_cost[i] + ((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCpm())/(horas_todas.get(j).get(k).get(k2)+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]));
									if(((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCpm())/(horas_todas.get(j).get(k).get(k2)+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]))<0) {
										System.out.println("Paila"+" "+(gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCpm())+" "+(horas_todas.get(j).get(k).get(k2)+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm() - LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1])+" "+horas_todas.get(j).get(k).get(k2)+" "+gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm()+" "+LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1]+" ");
									}
									...
									if(((gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCpm())/(gvrp.getNodes().get(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1).getCycletime()))<0) {
										System.out.println("Paila"+" "+(gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getCpm())+" "+(gvrp.getNodes().get(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1).getCycletime()));
									}

									//System.out.println(gvrp.getNodes().get(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1).getCycletime());
								}
								RNG=rndGenerator.nextDouble();
								NextFailure[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] =horas_todas.get(j).get(k).get(k2) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm() + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getD().inverseF(RNG); // Actualizo el tiempo de falla
								LastVisit[rutas_todas.get(j).get(k).get(k2).getEventsSitesID()-1] = horas_todas.get(j).get(k).get(k2) + gmm.getNodebyID(rutas_todas.get(j).get(k).get(k2).getEventsSitesID()).getTpm();
							}
				...
				while(continuar){ 
					...
					if (arrival_time < smallgraphs.get(j).getTmax()) { // alcanzo a visitarla dentro de la semana?
						...
						if(LastVisit[fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1] != 0){
							...
							denom_costo_ciclo++;
							main_cost[i] = main_cost[i] + ((gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCw() * (horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1) - NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1]) +gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCcm())/(arrival_time+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getTcm() - LastVisit[fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1])); 
							if(((gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCw() * (horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1) - NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1]) +gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCcm())/(arrival_time+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getTcm() - LastVisit[fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1]))<0) {
								System.out.println("Paila"+" "+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCw() * (horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1) - NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1]) +gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCcm()+" "+(arrival_time+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getTcm() - LastVisit[fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1]));
							}
							...
							if(((gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCw() * (horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1) - NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1]) +gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCcm())/(gvrp.getNodes().get(fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1).getCycletime()))<0) {
								System.out.println("Paila"+" "+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCw() * (horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1) - NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1]) +gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getCcm()+" "+gvrp.getNodes().get(fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0)))-1).getCycletime());
							}
						...
						RNG=rndGenerator.nextDouble();
						NextFailure[rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()-1] = arrival_time +  //Aqui horas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1)
								gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getTcm() + 
								gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getD().inverseF(RNG); // Actualizo el tiempo de falla

						LastVisit[fallas.get(tiempo_fallas.indexOf(s_tiempo_fallas.get(0))) - 1] = arrival_time+gmm.getNodebyID(rutas_todas.get(j).get(ruta_mod).get(rutas_todas.get(j).get(ruta_mod).size()-1).getEventsSitesID()).getTcm();
					...
					//Agregarlo donde debe estar
						int k = j + cycletimes[nueva.getEventsSitesID()-1];
						while(k < rutas_todas.size()){
							...
							Arrays.sort(sorted_ultima_nueva);
							...
							if(tiempo_ultima_n + travel_time2 < smallgraphs.get(k).getTmax()){
								...
								k = k + cycletimes[nueva.getEventsSitesID()-1];
							}else{
								k++;
							}
			...
			writer.println(i + "\t" + main_cost[i] + "\t" + las_que_fallaron[i] + "\t" + las_que_hice[i] + "\t" + prob_falla[i] + "\t" + costo_ciclo[i] + "\t" + oper_per_route);
//						System.out.println(i + "\t" + main_cost[i] + "\t" + las_que_fallaron[i] + "\t" + las_que_hice[i] + "\t" + prob_falla[i]+ "\t" + costo_ciclo[i]);
		}
		writer.close();
		writer2.close();
