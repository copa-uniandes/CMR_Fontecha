...
public class MNode {
	 ...
	 * @param pot exponent of the waiting cost  		
	 */
	
	public MNode(int id, double ccm, double cpm, double cw, double tcm, double tpm, double deltacost, double posx, double posy, double pot, ContinuousDistribution d,
			double waiting, int iteration, double opt, double cost) {
		this.id = id;
		this.ccm=ccm;
		this.cpm=cpm;
		this.cw=cw;
	...
	/**
	 * This method sets the time of preventive maintenance
	 * @param tpm time of preventive maintenance  
	 */
	...
	/**
	 * This method sets the deltacost in order to calculate the time windows
	...
	/**
	 * This method returns the exponent of waiting cost
	 * @oaran pot exponent.  
	 */
	...
	/**
	 * This method sets the exponent of waiting cost
	 * @oaran pot exponent.  
	 */
